...
class OnboardingActivity : AppCompatActivity() {
    ...
    private val characterMessages = listOf(
        listOf(
            ChatData("저는 [사용자]님의 우주에 살고 있는 모아에요.", "CHARACTER"),
            ChatData("우주를 보여줄게요!", "CHARACTER", R.drawable.ai_mypagestory_1),
            ChatData("이렇게 매일 경험하는 여러 순간들을 상황이라고 해요.", "CHARACTER"),
            ChatData("예를 들어, 친구와 함께 밥을 먹지 못하는 상황이 있을 수 있어요", "CHARACTER", R.drawable.ai_mypagestory_2)
        ),
        listOf(
            ChatData("맞아요!", "CHARACTER"),
            ChatData("상황 속에서 [닉네임]님의 우주에는 여러 가지 생각 행성이 나타나요", "CHARACTER"),
            ChatData("친구와 함께 밥을 먹지 못한 상황에서는...", "CHARACTER"),
            ChatData("'친구가 나를 피하는 것 같아'라는 생각 행성이 떠오를 수 있어요.'", "CHARACTER"),
            ChatData("이런 생각 행성이 나타나면 슬프고 속상해져서 감정 별이 뾰족하게 일그러질 수 있죠", "CHARACTER")
        ),
        listOf(
            ChatData("바로 그거예요!", "CHARACTER"),
            ChatData("이렇게 상황, 생각 행성, 그리고 감정 별은 서로 이어져 있어요.", "CHARACTER"),
            ChatData("똑같은 상황이라도 어떤 생각 행성을 떠올리는지에 따라 감정 별의 모양이 달라질 수 있죠", "CHARACTER"),
            ChatData("같은 상황에서 '친구가 바쁜가 보다'라는 생각 행성을 떠올리면...", "CHARACTER"),
            ChatData("슬픔으로 일그러진 감정 별이 안정될 수 있어요.", "CHARACTER"),
        ),
        listOf(
            ChatData("정확해요!", "CHARACTER"),
            ChatData("가끔은 [닉네임]님의 감정 별을 유독 슬프게 만드는 생각 행성이 나타나기도 해요.", "CHARACTER"),
            ChatData("그럴 땐 저와 함께 우주 속 생각 행성을 하나씩 살펴봐요!", "CHARACTER"),
            ChatData("감정 별을 힘들게 만드는 생각 행성을 찾아서 더 나은 생각 행성으로 바꾸면", "CHARACTER"),
            ChatData("감정 별이 다시 밝게 반짝일 거예요", "CHARACTER")
        )
    )
    ...
    private fun loadInitialChat() {
        chatList.add(ChatData("안녕하세요!", "CHARACTER", R.drawable.img_ch_situation))
