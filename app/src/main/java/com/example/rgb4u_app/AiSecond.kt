...
class AiSecond {
    ...
    private fun analyzeCognitiveDistortions(sentence: String, callback: (JSONObject) -> Unit) {
        ...
        인지 왜곡에 해당하면 다음을 아래 형식으로 JSON 형식으로 제시해줘:
        {
            ...
            "문장": "$sentence",
            "유형 이유": "이 유형에 해당하는 이유를 한국어 기준 200byte 이내로 작성해줘. 말투는 ~해요체이고, 친절하고 다정하게 설명해 주세요. 초등학생도 이해하기 쉬운 단어와 문장으로 작성해 주세요.",
            "대안적 생각": "이 문장 대신 하면 좋은 적응적인 생각을 74byte 문장 이내로 간단하게 작성해줘. 이 문장은 반말로, '나는 ~했어'와 같은 형태로 표현해 주세요.",
