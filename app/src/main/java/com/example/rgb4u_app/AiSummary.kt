...
class AiSummary {
    ...
    fun analyzeDiary(userId: String, diaryId: String, date: String, callback: () -> Unit) {
        ...
        userRef.get().addOnSuccessListener { dataSnapshot ->
            ...
            val prompt = """
            사용자가 입력한 문장을 분석하여 다음 항목을 구체적으로 분류하고, 각 항목에 대해 이유를 친근하고 부드러운 말투로 설명해 주세요. 분석된 항목들은 명확하게 구분되어야 하며, 감정은 단어로만 추출하지 말고 감정의 뉘앙스도 함께 담아주세요. 상황과 생각도 마찬가지로 구체적인 내용으로 분리해 주세요.
            
            1. **상황**: 사용자 입력에서 **객관적인 사건**이나 **사실적인 설명**을 추출해 주세요. 주관적인 해석이나 추측은 제외해 주세요.
               - 예시: "체육 시간에 발야구를 했어." (이것은 사실적인 설명이며 객관적인 사건입니다.)
               - 예시: "시험에서 50점을 받았어." (구체적인 사건을 나타냄)
            
            2. **상황 요약 이유**: 상황에서 어떤 일이 있었는지를 친절하고 간결하게 설명해 주세요.
               - 예시: "체육 시간에 발야구를 하다가 넘어졌어요." (상황의 핵심을 간단히 요약)
            
            3. **생각**: 사용자 입력에서 **주관적인 생각**이나 **의견**, **추측**을 추출해 주세요. 자신에 대한 생각이나 의문, 자책 등이 포함됩니다.
               - 예시: "나는 왜 잘하는 게 하나도 없을까?" (자기 비하적 생각)
               - 예시: "애들이 나를 비웃었을 거야." (주관적인 추측)
            
            4. **생각 요약 이유**: 생각에서 어떤 내용이 주관적이었는지, 그리고 왜 그것이 사용자의 생각으로 분류되는지 설명해 주세요.
               - 예시: "자기 자신에 대해 부정적인 생각을 했고, 친구들이 나를 비웃을 것 같다고 추측했어요." (자기 비하와 추측이 포함됨)
            
            5. **감정**: 사용자 입력에서 나타나는 감정 표현을 추출하고, **감정의 뉘앙스**까지 포함해 주세요. 예를 들어, '슬프다', '걱정된다'와 같이 감정의 구체적인 표현을 포함시켜 주세요. 또한, 감정의 강도나 깊이를 표현할 수 있으면 더 좋습니다. 예: "조금 슬프다" 또는 "굉장히 우울하다".
               - 예시: "너무 창피해." (구체적인 감정을 나타내며, 감정의 강도도 포함됨)
               - 예시: "진짜 우울해." (감정의 강도가 매우 강함)
            ...
            {
                "name": "analyze_text",
                "description": "사용자의 텍스트를 분석하여 감정, 상황, 생각을 분류하고, 각 항목에 대한 이유를 설명해 주세요.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "emotion": {
                            "type": "array",
                            "items": { "type": "string" },
                            "description": "텍스트에서 확인된 감정 목록. 예: '슬프다', '걱정된다'. 감정은 명확하고 구체적으로 표현해 주세요."
                        },
                        "situation": {
                            "type": "string",
                            "description": "텍스트에서 묘사된 상황. 객관적인 사건이나 사실적인 설명만 포함해 주세요."
                        },
                        "thoughts": {
                            "type": "string",
                            "description": "텍스트에서 묘사된 생각. 주관적인 의견, 판단, 추측 등을 포함해 주세요."
                        },
                        "situationReason": {
                            "type": "string",
